    ...
    <div class="row">
      ...
      <div class="col-md-6 sdc-user-right">
        <div class="user-right-pwd">
          <form action="<?php echo U('memberPwd');?>" method="post" class="form-horizontal" role="form">
            <input type="hidden" name="id" value="<?php echo ($userinfo['id']); ?>">
            <div class="form-group">
              <label for="firstname" class="col-sm-2 control-label">输入新密码</label>
              <div class="col-sm-8">
                <input type="password" class="form-control" id="password" name="password" placeholder="密码长度为6-20位" pattern=".{6,20}" required>
              </div>
            </div>
            <div class="form-group">
              <label for="lastname" class="col-sm-2 control-label">再次输入新密码</label>
              <div class="col-sm-8">
                <input type="password" class="form-control" id="confpassword" name="confpassword" placeholder="再次输入新密码" required>
              </div>
            </div>
            <div class="form-group">
