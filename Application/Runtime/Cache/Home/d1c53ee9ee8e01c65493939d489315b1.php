    ...
    <div class="row">
      ...
      <div class="col-md-6 sdc-user-right">
        ...
        <div class="user-right-bot">
          <p><?php echo ($htmlData["title"]); ?></p>
          <table>
            <tr align="center" class="volume-table-header">
              <td><?php echo ($htmlData["header_a"]); ?></td>
              <td><?php echo ($htmlData["header_b"]); ?></td>
              <td><?php echo ($htmlData["header_c"]); ?></td>
            </tr>
            <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr align="center" class="volume-table-list">
              <td><?php echo date('Y-m-d H:i:s',$var['add_time']);?></td>
              <td><?php echo ($var['volume']); ?></td>
