  ...
  <nav class="navbar navbar-default" data-spy="affix" data-offset-top="450">
    <div class="container">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="hidden-xs hidden-sm"><a href="#">SDC</a></li>
        <li class="hidden-xs hidden-sm"><a href="#">购买</a></li>
        <li class="hidden-xs hidden-sm"><a href="#">用户中心</a></li>
        <li class="hidden-xs"><a href="<?php echo U('signin');?>">登录</a></li>
        <li><a href="<?php echo U('signup');?>" class="btn btn-nav">注册</a></li>
  ...
  <div class="mobile-nav-overlay hidden-md hidden-lg" id="mobile-nav-overlay">
    <nav class="mobile-nav">
      <ul>
        ...
        <li><a href="#reviews">SDC</a></li>
        <li><a href="#faq">购买</a></li>
        <li><a href="#team">用户中心</a></li>
        <li class="hidden-sm"><a href="signin.html">登录</a></li>
      </ul>
    </nav>
  </div>
  ...
  <section class="container text-center welcome-message" id="home">
    <div class="row">
      <div class="col-md-12" style="height: 200px">
        <!-- <h1>Landing page for your product or service</h1>
        <h2>Use this template to promote and describe the benefits of your product.</h2>
        <a href="signup.html" class="btn btn-cta-hero">GET STARTED</a>  -->
      </div>
    </div>
  </section>
...
<div class="learn-more section-spacing">
  <div class="container">
    <div class="row" id="company" style="border-bottom: 0">
      <div class="col-md-6 col-md-push-6">
        <aside class="text-center">
          <figure> <img src="/Public/Home/img/learn-more-1.jpg" alt="learn more"> </figure>
        </aside>
      </div>
    ...
    <div class="row" id="introduction">
      <div class="col-md-6">
        <aside class="text-center">
          <figure> <img src="/Public/Home/img/learn-more-2.jpg" alt="learn more"> </figure>
        </aside>
      </div>
      <div class="col-md-6">
        <article>
...
<section class="how-it-works section-spacing">
  <div class="container">
    <header class="section-header text-center">
      ...
      <p>中国的过程。我们使用钻石直接从煤矿，它是通过我们的密集型分类与评价过程选择的手。我们的钻石</p>
      <p>有GIA证书，将全球标准。NDSC计划在每年一百万克拉以上的过程。</p>
    </header>
    <div class="row">
      <div class="col-md-11 center-block"> 
        ...
        <!--step 1-->
        <div class="row">
          <div class="col-md-6 col-md-push-6 text-center"> <img src="/Public/Home/img/step-1.svg" alt="step-1"> </div>
          <div class="col-md-6 col-md-pull-6">
        ...
        <!--step 2-->
        <div class="row">
          <div class="col-md-6 text-center"> <img src="/Public/Home/img/step-2.svg" alt="step-2"> </div>
          <div class="col-md-6">
        ...
        <!--step 3-->
        <div class="row">
          <div class="col-md-6 col-md-push-6 text-center"> <img src="/Public/Home/img/step-3.svg" alt="step-3"> </div>
          <div class="col-md-6 col-md-pull-6">
        ...
        <!--step 4-->
        <div class="row">
          <div class="col-md-6 text-center"> <img src="/Public/Home/img/step-4.svg" alt="step-4"> </div>
          <div class="col-md-6">
...
<section class="cta section-spacing text-center" style="background-color: #31aff5">
  <div class="container">
    <div class="row">
      <div class="col-md-8 center-block">
        <h2 class="font-fff">Diamond + Cryptocurrency = SDC</h2>
        <p class="font-fff">专业不仅仅是一个钻石商人。随着blockchain技术的出现，我们看到的机会，把这两个令</p>
